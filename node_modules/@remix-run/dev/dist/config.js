...
async function resolveConfig(appConfig, {
  ...
  if (isSpaMode && ((_appConfig$future2 = appConfig.future) === null || _appConfig$future2 === void 0 ? void 0 : _appConfig$future2.unstable_fogOfWar) === true) {
    throw new Error("You can not use `future.unstable_fogOfWar` in SPA Mode (`ssr: false`)");
  }
  ...
  let future = {
    ...
    unstable_fogOfWar: ((_appConfig$future7 = appConfig.future) === null || _appConfig$future7 === void 0 ? void 0 : _appConfig$future7.unstable_fogOfWar) === true
  };
  if (appConfig.future) {
